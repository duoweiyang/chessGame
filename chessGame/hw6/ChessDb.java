...
/**
 * Contains all the information from the chess games.
 *
 * @author dyang305
 * @version 1.0
 */
public class ChessDb {
    ...
    /**
     * Creates an ArrayList consisting of the contents of each chess game.
     */
    public ChessDb() {
        games = new ArrayList<>();
    ...
    /**
     * All the attributes of the chess game morphyIsouard.
     */
    ...
    /**
     * All the attributes of the chess game talFischer.
     */
